...
### Attack Complexity
Staleus operates as a fully deterministic, software-only exploit with a 100% success probability. It does not require single-stepping, any code running inside the victim CVM, or physical access to the hardware.
